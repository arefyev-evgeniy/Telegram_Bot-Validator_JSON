...
bot = TeleBot(token='5686074365:AAH-1NZ520D_bdP0Z_ggKyjCbNGEgU5IVi4', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Я могу проверить JSON и оформит его в красивый текст\nВведи JSON в виде строки:', # текст сообщения
    )
